...
class T5FileSummarizer:
    def __init__(self, model_name: str = 't5-base', max_chunk_len: int = 512):
    ...
    def summarize_file(self, file_path: str, max_length: int = 150, min_length: int = 40) -> str:
